 ...
 */
public class GeradorDeScriptOracle implements GeradorDeScript {
    ...
    public String getScript(String tabela, List<Campos> camposList) {
        ...
        script.append("\n\n");
        script.append("CREATE SEQUENCE ").append(tabelaUpperCase).append("_SEQ START WITH 0 INCREMENT BY 1 NOCACHE NOCYCLE");
